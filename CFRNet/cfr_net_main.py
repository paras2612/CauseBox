...
import datetime
import traceback
from CFRNet.utils import *
import CFRNet.cfr_net as cfr
...
tf.compat.v1.app.flags.DEFINE_float('lrate', 1e-3, """Learning rate. """)
...
tf.compat.v1.app.flags.DEFINE_integer('experiments', 10, """Number of experiments. """)
...
def train(CFR, sess, train_step, D, I_valid, D_test, logfile, i_exp):
    ...
    dict_factual = {CFR.x: D['x'][I_train,:], CFR.t: D['t'][I_train,:], CFR.y_: D['yf'][I_train,:],CFR.do_in: 1.0, CFR.do_out: 1.0, CFR.r_alpha: FLAGS.p_alpha,CFR.r_lambda: FLAGS.p_lambda, CFR.p_t: p_treated}
