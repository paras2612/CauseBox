...
import CFRNet.evaluation as evaluation
from CFRNet.plotting import *
...
def evaluate(config_file, overwrite=False, filters=None):
    ...
    res.columns = ["MODEL", "DATASET", "RMSE_ITE", "ATE_PRED", "ATT_PRED", "BIAS_ATT", "ATC_PRED", "BIAS_ATC", "BIAS_ATE", "RMSE_FACT", "POLICY_CURVE", "POLICY_VALUE", "PEHE", "PEHE_NN", "POLICY_RISK"]
